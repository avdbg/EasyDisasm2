...
dis_insn *x86dis::createInvalidInsn()
{
	return NULL;
}

void x86dis::hexd(char **s, int size, int options, uint32 imm)
{
	char ff[16];
	char *f = (char*)&ff;
	char *t = *s;
...
void x86dis::hexq(char **s, int size, int options, uint64 imm)
{
	char ff[32];
	char *f = (char*)&ff;
	char *t = *s;
...
bool x86dis::selectNext(dis_insn *disasm_insn)
{
	return false;
}
